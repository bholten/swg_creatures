...
**SOME OF THESE ARE OBVIOUSLY WRONG** so please, contain your autism. For example, Kiin'Dray comes up because it spawns dynamically when a boss is killed -- and it's too much effort to scrape Core3 data to the level of figuring out all the dynamic or mission-trigger spawns.
